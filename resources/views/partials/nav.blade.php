      ...
      <div class="left-sidebar-scroll">
        <div class="left-sidebar-content">
          <ul class="sidebar-elements">
            ...
            <li class={{ (Request::is('health-monitor') or Request::is('home') or Request::is('/')) ? 'active' : null }}><a href="{{action('HealthMonitorController@index')}}"><i class="icon mdi mdi-chart"></i><span>Health Monitor</span></a></li>
            ...
            <li class={{ Request::is('profile') ? 'active' : null }}><a href="{{action('SettingsController@index')}}"><i class="icon mdi mdi-settings"></i><span>Profile</span></a></li>
